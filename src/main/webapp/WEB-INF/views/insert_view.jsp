...
<body>
	...
	<form id="loginForm" action="write" method="post">
		...
		급여&nbsp;<input id="sal" type="number" name="sal" placeholder="ex)4200"><br>
		
		커미션(선택)&nbsp;<input type="number" name="comm" placeholder="ec)500"><br>
		...
		<input id="resBtn" type="reset" value="초기화">&nbsp;&nbsp;
		<input type="button" value="돌아가기" onclick="location.href='tables'">
	</form>
</body>
</html>